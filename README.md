...
## Insights
- **Top 5 item types** generate the highest revenue
- customer ratings remain **consistent across categories**
## Conclusion
This analysis helps identify high-performing products and customer behavior patterns,enabling better inventory and marketing strategies.
#Tools used
- **sql**
- **Excel/CSv**
- **Github**
